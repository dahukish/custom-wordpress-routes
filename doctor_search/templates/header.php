...
<link type="text/css" rel="stylesheet" media="only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (-webkit-min-device-pixel-ratio: 2)" href="<?php echo get_stylesheet_directory_uri(); ?>/responsive/iPad-Retnia-Display.css" />
...
?>
<link type="text/css" rel="stylesheet" href="<?php echo CDS_PLUGIN_URL; ?>/styles/doctors.css" />
</head>
